...
insert into workspaces(id, archive, is_favourite, name, creator_id)
values (1, false, false, 'Peaksoft House', 1),
       (2, false, false, 'Makers', 2),
       (3, false, false, 'DevX', 3),
       (4, false, false, 'IT School', 4),
       (5, false, false, 'MegaCom', 5);
